...
| [☕ Java](./JAVA/) | Материалы по Java и разработки ПО |
| [🌿 Git](./GIT/) | Основы Git, команды, рабочие процессы |
| [🗃️ Базы данных](./DB/) | SQL/NoSQL, проектирование БД, оптимизация запросов |
| [🧠 Машинное обучение](./ML/) | Теория машинного обучения, модели, классический ML |
...
| [🖥️ Основы системного администрирования](./OSA/) | Компьютерные сети, операционные системы, DevOps |
